...
namespace Halo.Utilities
{
    public class Sanitize
    {
        ...
        /// except for the ones explicitly allowed in the second parameter.  If allowed, this method DOES NOT strip out attributes.
        /// </summary>
        ...
        {
            return StripTag(htmlString, null);
        }
        ...
        /// </summary>
        /// <param name="htmlString">The HTML string.</param>
        /// <param name="listOfAllowedTags">The list of allowed tags.</param>
        /// <returns>
        /// Cleaned String
        /// </returns>
        /// <createdate>10-27-2011</createdate>
        ...
        public static string StripTag(string htmlString, string listOfAllowedTags)
        {
            ...
            if (!string.IsNullOrEmpty(listOfAllowedTags))
            {
                ...
                foreach (string allowedTag in listOfAllowedTagsArray)
                {
                    ...
                    string patternVersion2 = "<" + allowedTag + " [^><]*>$"; // <img src=stuff  or <hr style="width:50%;" />
